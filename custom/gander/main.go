...
func build_gander(game *gizzmo.Game) {
	...
	hole := gizzmo.NewTexture("polar.png", 90)
	...
	moon := gizzmo.NewTexture("moon-solo-300.png", 30)
	...
	gander := gizzmo.NewTexture(filepath.Join("gander.png"), 58)
	...
	head := gizzmo.NewTexture("head_300.png", 28)
	...
	door := gizzmo.NewTexture(filepath.Join("doorstop_01.png"), 28)
